...
int main()
{
    ...
    String haar_fullbody = "/home/andrea/Desktop/haarcascade_pedestrian.xml";
    CascadeClassifier people_cascade; // Class for the cascade classifier

    // VideoCapture cap("vtest.avi");
    VideoCapture sequence("../../Dataset/Our_Video/test1.mp4"); // convert into a realsense video streaming
